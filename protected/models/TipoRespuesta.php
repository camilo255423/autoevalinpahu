 ...
 * @property OpcionesRespuesta[] $opcionesRespuestas
...
class TipoRespuesta extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_tipo_respuesta, titulo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'opcionesRespuestas' => array(self::HAS_MANY, 'OpcionesRespuesta', 'id_tipo_respuesta'),
			'preguntaProcesos' => array(self::HAS_MANY, 'PreguntaProceso', 'id_tipo_respuesta'),
		);
	}
